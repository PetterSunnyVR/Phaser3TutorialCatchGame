class Spawner extends Phaser.GameObjects.GameObject{
    constructor(scene,spawn_group,spawn_time_max,spawn_time_min,spawn_object_limit){
        super(scene,"Spawner");
        this.scene = scene;
        //goupd to keep all the objects to be reused
        this.spawn_group = spawn_group;
        //how many objects can be spawned at the same time
        this.spawn_object_limit = spawn_object_limit;
        //group size limit
        ...
        this.spriteKeysArray = ['meteoroid1', 'spaceShip'];
        //how often we will spawn new falling objects
        this.spawn_time_min = spawn_time_min;
        this.spawn_time_max = spawn_time_max;
        //start spawning
    ...
    spawnCallback(){
        ...
        for( let i = 0; i< randomObjectNumber; i++){
            ...
            if(!falling_obj || this.spawn_group.children.size < this.spawn_group_limit){
                ...
                if(this.spriteKeysArray[randomIndex]=='meteoroid1' && this.meteor_count<this.meteor_limit){
                ...
                else if (this.spriteKeysArray[randomIndex]=='spaceShip' || this.meteor_count>=this.meteor_limit)
                {
